...
Catálogo mestre do Zettelkasten. Mantenha cada linha no formato definido no `GEMINI.md` (wikilink sem ID no link, ID entre parênteses quando aplicável). Atualize este arquivo a cada ingestão, síntese ou rascunho relevante.
