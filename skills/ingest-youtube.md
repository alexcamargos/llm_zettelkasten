...
Na conversa com o usuário pode usar listas para clareza; isso **não** se aplica ao texto gravado em `zettelkasten/`.
...
1. Atualize `zettelkasten/index.md` na seção **Transcrições do YouTube**. Se a seção não existir, crie-a próxima de **Fontes web informais**.
