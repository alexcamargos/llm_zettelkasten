...
Nenhuma sessão foi consolidada ainda. Inicie o fluxo com `/start` e, ao terminar o trabalho, use `/close` para gravar aqui o foco e as pendências da próxima sessão.
